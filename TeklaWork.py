...
from Tekla.Structures.Model import Model, Beam,Position,BooleanPart,Solid, Part
...
def InputIKomponent(input_datas):
    ...
    for wall in input_datas.sections:
        ...
        solid = cut_beam.GetSolid()
        # # solid.Father = cut_beam
        # part=Part()
        # part.SetSolid(solid)
        ...
        # cut = Cut()
        # cut.Father = beam
        # cut.SetSecondaryObject(cut_beam)
    
        # # Устанавливаем тип выреза
        # cut.Type = Cut.CutTypeEnum.CUT_SOLID
